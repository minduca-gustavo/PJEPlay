...
// Toda busca de elemento deve passar por sel() ou rota_aguardarElemento().
// =============================================================================
  ...
  },
  {
    ...
    seletores: {
      ...
      pautaDeAudienciaMetaQuadroHorariosVagos: {
        seletor: 'meta[name="rotapje-horarios_vagos"]',
      },
      tarefaDoProcessoTituloDaTarefa: {
        seletor: '.texto-tarefa-processo',
      },
...
// Acumulador silencioso — alimentado por sel() e rota_aguardarElemento().
...
// A busca base pelo seletor CSS vem de modulos/dom.js (selecionar()).
// A redefinição local foi removida: era idêntica, e manter duas
// implementações do mesmo nome era a única colisão real de nome
// global entre Rota e SISE fora da antiga pasta rota/modulos/.
...
// aguardarElementoMudar() mudou para nucleo/rota-nucleo.js.
